...
The **`https://data.spiceai.io/eth`** API is a [Ethereum JSON-RPC](https://eth.wiki/json-rpc/api) compatible endpoint that can be used with web3 clients like [web.js](https://web3js.readthedocs.io) and [ether.js](https://docs.ethers.io).
...
Spice Data supported methods are:
