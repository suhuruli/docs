...
[**Ethereum Token datasets**](reference/sql-query-tables/sql-query-tables/token-tables/)
...
[**Ethereum NFT datasets**](reference/sql-query-tables/sql-query-tables/nft-tables/)
...
[**Ethereum Uniswap datasets**](reference/sql-query-tables/sql-query-tables/uniswap-v2-tables/)
...
[**Ethereum Sushiswap datasets**](reference/sql-query-tables/sql-query-tables/sushiswap-tables/)
...
[**Ethereum Name Service (ENS) datasets**](reference/sql-query-tables/sql-query-tables/token-tables-1/)
...
#### [Ethereum Aave V2 datasets](reference/sql-query-tables/sql-query-tables/aave-v2-tables/)
